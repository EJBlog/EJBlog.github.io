    ...
    <body >
        ...
        <main class="container left-container">
            <div class="row">
                ...
                <!-- Need to change our sidebar image for contact page -Evan -->
                <section class="sidebar col-md-5 col-sm-12" style="background-image: url(img/default-contact.jpg)">
                    ...
                    <div class="site-info">
                        ...
                        <h1>Contact</h1>
                            <p>Tell us what you think. We're open to all feedback, comments, questions, or whatever else you'd like to say.</p>

                        </div>
                        <div class="secondary-info">

                            <p><a class="btn btn-default" href="#"><i class="fa fa-user-plus"></i>Newsletter Signup</a>
                        </div>
                    </div>
                ...
                <!--
                    <form method="post" action="mailto:ejpersonalblog@gmail.com">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" placeholder="John Smith" class="form-control" name="name">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" placeholder="youremail@email.com" class="form-control" name="email">
                        </div>
                        <div class="form-group">
                            <label for="company">Company</label>
                            <input type="text" placeholder="My Company Inc." class="form-control" name="company">
                        </div>

                        <div class="form-group">
                            <label for="number">Phone Number</label>
                            <input type="tel" placeholder="+1234567890" class="form-control" name="number">
                        </div>

                        <div class="form-group">
                            <label for="message">Message</label>
                            <textarea class="form-control" name="message" placeholder="I love your blog posts, stay awesome."></textarea>
                        </div>
